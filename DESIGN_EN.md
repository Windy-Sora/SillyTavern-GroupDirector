# Group Director — Design Document
...
Group Director provides full export/import capability for five data types:
...
Group Director allows users to import and write custom code (User Providers, User Capabilities, Script Executors). This code runs in SillyTavern's page context with the same privileges as SillyTavern itself — including access to localStorage, making HTTP requests, and manipulating the DOM.
