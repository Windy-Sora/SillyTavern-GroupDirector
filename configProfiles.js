...
registerSection('configProfiles', function (ctx) {
    ...
    $c('cfg-save-btn').off('click').on('click', function () {
        ...
        console.log('[GD-cfgProfiles] saved profile:', name, 'total profiles:', sys.getProfiles().length);
        $c('cfg-save-name').val('');
        $c('cfg-save-desc').val('');
        renderList();
        populatePresetDropdown();
    ...
    function populatePresetDropdown() {
        ...
        console.log('[GD-cfgProfiles] populatePresetDropdown — sel found:', !!$sel.length, 'profiles:', sys.getProfiles().length);
