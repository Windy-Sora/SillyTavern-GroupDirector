...
const I18N = {
    zh: {
        ...
        psMsgPromptLabel: '每次发言 Prompt（留空使用内置默认，支持所有 Provider）',
        psMsgPromptReset: '恢复默认',
        psRoundEnabled: '回合结束后激活 PostSpeech',
        psRoundPromptLabel: '回合结束 Prompt（留空使用内置默认，支持所有 Provider）',
    ...
    en: {
        ...
        testerLocalsLabel: 'Locals (JSON, optional, simulates Agent data placeholders)',
        testerOutput: 'Output',
        ...
        psMsgPromptLabel: 'Per-message Prompt (leave empty for default, all Providers supported)',
        psMsgPromptReset: 'Reset',
        psRoundEnabled: 'Activate PostSpeech after round ends',
        psRoundPromptLabel: 'Per-round Prompt (leave empty for default, all Providers supported)',
        psRoundPromptReset: 'Reset',
        psBlocking: 'Blocking mode (uncheck = async background)',
        psCapabilitiesTitle: 'Registered Capabilities',
        psCapabilitiesHint: 'Enable/disable individual capabilities. Disabled won\'t be considered by the LLM.',
        psRefresh: 'Refresh',
