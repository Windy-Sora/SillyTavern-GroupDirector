...
const I18N = {
    zh: {
        ...
        forceSpeakHint: '当用户在群聊中手动强制触发某个角色发言时，Group Director 的处理方式。',
        ...
        cfgExportManifest: '导出清单 (.json)',
        cfgExportManifestShort: '清单',
    ...
    en: {
        ...
        forceSpeakHint: 'How Group Director handles manual force-speak triggers in group chat.',
        ...
        cfgExportManifest: 'Export Manifest (.json)',
        cfgExportManifestShort: 'Manifest',
